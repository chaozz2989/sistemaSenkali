...
require "../funciones/fProductos.php";
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-7 connectedSortable">
                            <div class="box box-primary">
                                ...
                                <form role="form" action="../funciones/fProductos.php?<?php echo encode_this('acc=1');?>" method="post"><!--Hace referencia al archivo que controla todas las consultas referentes a productos-->
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>
                                                <input type="checkbox" class="minimal" name="prodEspecial" value="1">
                                            </label> 
                                        </div>
                                    </div>
