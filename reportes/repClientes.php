                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="nombre" name="nombre" type="text" class="form-control" placeholder="Busque por nombre" aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="dui" name="dui" type="text" class="form-control" placeholder="Busque por DUI" aria-describedby="basic-addon1">
                                                </div>
                                            </div>

                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <?php $data = comboEstadoUsuario(); ?>
                                                    <label>Estado</label>
