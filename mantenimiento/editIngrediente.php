                            ...
                            <?php if ($query != null): ?>
                                <div class="box-body">
                                    <form role="form" method="post" action="../funciones/fIngredientes.php?<?php echo encode_this("acc=2&id_ing=" . $idRe['id_ing']); ?>">
                                        <?php foreach ($query as $resultado => $campoIngrediente) { ?>
                                            <div class="form-group">
                                                <label>Ingrediente</label>
                                                <input type="text" class="form-control" value="<?php echo $campoIngrediente['ingrediente']; ?>" name="nombreIng" required="true">
                                            </div>

                                            <div class="form-group">
                                                <label>Costo</label>
                                                <input type="text" class="form-control" value="<?php echo $campoIngrediente['costo']; ?>" name="costoIng" required="true">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php 
                                                        ...
                                                        if ($registro['id_categoria'] == $campoIngrediente['id_categoria']) {
                                                            echo " selected=true ";
                                                        }
                                                ...
                                                <input type="radio" id="dispIng" name="dispIng" value="" /> &nbsp;&nbsp; SI
                                                <input type="radio" id="dispIng" name="dispIng" value="" /> &nbsp;&nbsp; SI
                                            </div>
