                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Lista de Ingredientes</h3>
                                </div>
                                <?php $data=getIngredientes(); ?>
                                <!-- /.box-header -->
                                <div class="box-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:150px;">
                                                    <a href="editIngrediente.php?<?php echo encode_this('id_ing='.$registro["id_ingrediente"]); ?>" class="btn btn-sm btn-warning">Editar</a>
                                                </td>
                                            </tr>
                                            <?php }?>
                                        </tbody>
